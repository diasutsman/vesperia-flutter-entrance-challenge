...
class ProductListPage extends GetWidget<ProductListController> {
  ...
  Widget buildProductList(BuildContext context) => DynamicHeightGridView(
        ...
        builder: (context, index) {
          ...
          return buildProductItem(product: product, index: index);
        },
      );
...
class FooterLoadingIndicator extends StatelessWidget {
  final bool isLoading;

  const FooterLoadingIndicator({Key? key, required this.isLoading})
      : super(key: key);
